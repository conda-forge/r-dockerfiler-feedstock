...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-dockerfiler-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8806&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-dockerfiler-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-dockerfiler` can be installed with:

```
conda install r-dockerfiler
```

It is possible to list all of the versions of `r-dockerfiler` available on your platform with:
